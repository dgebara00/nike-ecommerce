...
function FooterLink({ href, children }: FooterLinkProps) {
	return (
		<Link href={href} className="text-body font-body text-dark-700 transition-colors hover:text-light-100">
			{children}
		</Link>
	);
}
				...
				<div className="flex flex-col gap-12 lg:flex-row lg:justify-between">
					...
					<div className="shrink-0">
						<Link href="/" aria-label="Nike Home">
							<Image src="/logo.svg" alt="Nike" width={60} height={22} className="h-5.5 w-auto brightness-0 invert" />
						</Link>
					</div>
