...
export const FilterGroupSkeleton = () => {
	return (
		<>
			<div className="h-8 w-24 animate-pulse rounded bg-light-300 lg:hidden" />
			<div className="hidden h-screen w-80 max-w-[85vw] animate-pulse rounded bg-light-300 lg:w-64 lg:translate-x-0 lg:sticky lg:top-24 lg:block" />
		</>
	);
};
...
export default function FilterGroup({ filters, categoryLinks = [], totalProducts }: FilterGroupProps) {
