...
export default function Filter({ label, options, selectedValues, onChange, defaultExpanded = true }: FilterProps) {
	...
	return (
		<div className="border-b border-light-300 py-4">
			<button
				...
				className="cursor-pointer flex w-full items-center justify-between text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-dark-900 focus-visible:ring-offset-2"
